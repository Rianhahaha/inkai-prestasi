    ...
    return (
      <>
        <section className="w-full bg-[#C5DDFF] ">
          <div className="w-full min-h-[200px] flex gap-5 justify-start items-center  px-6 max-w-7xl mx-auto">
            <Link href={'/atlet#daftar-atlet'} className="flex justify-center items-center">
              <ArrowLeft />
            </Link>
